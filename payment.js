...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const programPricing = {
        course1: { name: 'Course 1 - Trading Career Consultation', priceINR: '₹1,999',  priceUSD: '$22'  },
        course2: { name: 'Course 2 - 14-Day Live Trading Workshop', priceINR: '₹6,999',  priceUSD: '$78'  },
        course3: { name: 'Course 3 - Professional Trading Mastery', priceINR: '₹24,999', priceUSD: '$278' }
    };
    ...
    programOptions.forEach(option => {
        option.addEventListener('click', function () {
            ...
            const d = programPricing[selectedProgram];
            selectedProgramInput.value = d.name;
            amountInput.value = `${d.priceINR} (${d.priceUSD})`;
        });
    });
    ...
    paymentMethodBtns.forEach(btn => {
        btn.addEventListener('click', function () {
            ...
            if (method === 'crypto') {
                ...
                showUPIModal(labels[method] || method);
            }
        });
    });
    ...
    function showUPIModal(methodLabel) {
        ...
        modalBody.innerHTML = `
            ...
            <div class="qr-container">
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=upi://pay?pa=Skip9to5@upi%26pn=Skip9to5%26cu=INR"
            ...
            <div class="upi-info">
                ...
                <p class="scan-note">Amount: <strong style="color:#d9a441">${amount}</strong><br/>${program}</p>
            </div>
